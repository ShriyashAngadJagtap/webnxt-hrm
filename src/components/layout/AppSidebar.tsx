...
const navItems = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { label: "Edit Employee", path: "/employees/edit" },
      { label: "Employee Shift", path: "/employees/shift" },
      { label: "Employee Profile", path: "/employees/profile" },
      { label: "Employee Documents", path: "/employees/documents" },
      { label: "Employee Assets", path: "/employees/assets" },
      { label: "Employee Performance", path: "/employees/performance" },
