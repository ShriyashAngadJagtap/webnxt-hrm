...
export const AppSidebar = () => {
  ...
  return (
    <aside className="h-screen w-[250px] bg-white flex flex-col border-r border-gray-100 shrink-0">
      {/* Logo */}
      <div className="flex items-center gap-2.5 px-5 h-16 border-b border-gray-100 shrink-0">
        <div className="w-8 h-8 rounded-lg bg-orange-500 flex items-center justify-center">
          <span className="text-white font-bold text-sm">W</span>
        </div>
        <span className="text-[15px] font-bold text-gray-800">WebNxt</span>
      </div>

      {/* User Profile */}
      <div className="flex flex-col items-center py-5 border-b border-gray-100">
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center text-white text-xl font-bold mb-2">
          SJ
        </div>
        <p className="text-sm font-semibold text-gray-800">Shriyash Jagtap</p>
        <p className="text-[11px] text-gray-400">Admin</p>
      </div>

      {/* Nav Label */}
      <div className="px-5 pt-4 pb-1">
        <p className="text-[10px] uppercase tracking-widest text-gray-400 font-semibold">Main</p>
      </div>
      ...
      <div className="p-3 border-t border-gray-100 space-y-0.5">
        <Link to="/settings" className="sidebar-item sidebar-item-inactive">
          <Settings className="w-[18px] h-[18px] shrink-0 text-gray-400" />
          <span>Settings</span>
        </Link>
      </div>
    </aside>
