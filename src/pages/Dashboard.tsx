...
const invoices = [
  { no: "#IN7865", client: "John Doe", dueDate: "12/05/2016", status: "Paid", total: "$500" },
  { no: "#IN7866", client: "Sarah Smith", dueDate: "01/15/2017", status: "Pending", total: "$1,200" },
  { no: "#IN7867", client: "Mike Wilson", dueDate: "02/20/2017", status: "Paid", total: "$750" },
  { no: "#IN7868", client: "Emily Davis", dueDate: "03/10/2017", status: "Overdue", total: "$2,100" },
];
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm text-center">
              ...
              <p className="text-xl font-bold text-gray-800">$20,125</p>
            </div>
            <div className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm text-center">
